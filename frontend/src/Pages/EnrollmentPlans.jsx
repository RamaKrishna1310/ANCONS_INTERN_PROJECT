...
export default function EnrollmentPlans() {
    ...
    useEffect(() => {
        reset({
            ...
            isCaapApplication: student?.enrollmentPlan?.isCaapApplication ? "TRUE" : "FALSE",
            optionalTest: student?.enrollmentPlan?.optionalTest ? "TRUE" : "FALSE",
            honorsProgram: student?.enrollmentPlan?.honorsProgram ? "TRUE" : "FALSE",
            onCampusHousing: student?.enrollmentPlan?.onCampusHousing ? "TRUE" : "FALSE",
            financialAid: student?.enrollmentPlan?.financialAid ? "TRUE" : "FALSE",
        });
        ...
        <>
            <div className="w-[75%] p-4 mt-[-28px]">
                ...
                <form onSubmit={handleSubmit(handleSubmitEnrollmentPlan)}>
                    ...
                    <select name="selectedGraduationType" {...register("selectedGraduationType")} required>
